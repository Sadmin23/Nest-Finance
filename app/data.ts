...
export const Filter = [
  ...
  const ShortName = [
    ...
    {id: 'Arafah', name: 'Al-Arafah Islami Bank Limited'},
    ...
    {id: 'MBL', name: 'Mercantile Bank Limited'},
    {id: 'Midland', name: 'Midland Bank Limited'},
    {id: 'M. moti', name: 'Modhumoti Bank Limited'},
    ...
    {id: 'Prime', name: 'Prime Bank Limited'},
