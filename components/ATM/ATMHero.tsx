...
const ATMHero = (): JSX.Element => {
  ...
  return (
    <div className='xl:flex items-center my-12'>
        <div className='flex-col mt-1 w-full xl:w-4/6'>
            <h1 className='text-2xl font-bold tracking-wide w-full xl:w-5/6'>Search and find your nearest Automated teller machine (ATM)</h1>
            <h2 className="mt-5">
