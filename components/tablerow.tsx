...
const Tablerow = (): JSX.Element => {
  ...
  return (
    <div className='bg-white flex h-48 font-medium'>
        <div className='flex-col ml-10 mr-16 mt-6'>
            <Image
        ...
        <div className='flex my-auto'>
            <svg xmlns="http://www.w3.org/2000/svg" width="137" height="17" viewBox="0 0 113 17" fill="none">
            ...
            <h1 className='pl-20'>$0</h1>
            <h1 className='pl-36'>$200</h1>
            <div className='pl-28 flex-col'>
                <h1>2%</h1>
                <h1>Cashback</h1>
            </div>
            <h1 className='pl-28'>Apply Now</h1>
        </div>
    </div>
  );
};
